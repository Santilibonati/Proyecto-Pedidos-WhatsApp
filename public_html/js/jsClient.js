...
const products = [
  ...
  },
  {
    ...
    price: 8000,
    image: "./img/brownie-con-helado.png",
    category: "Desayunos/Meriendas",
  },
  {
    id: 10,
    ...
    price: 5000,
    image: "./img/cafe-2-medialunas.png",
    category: "Desayunos/Meriendas",
    popular: true,
  },
  {
  ...
  },
  {
    ...
    price: 4500,
    image: "./img/torta-chaja-foto-principal.jpg",
    category: "Tortas",
  },
  {
    id: 13,
...
function confirmAddToCart(productId) {
  ...
  if (!selections.flavors || Object.keys(selections.flavors).length === 0) {
    //showWarningMessage(`${product.name} agregado al carrito`)
    showWarningMessage("Debes seleccionar al menos un sabor antes de agregar al carrito");
    //alert("Debes seleccionar al menos un sabor antes de agregar al carrito.");
...
function sendWhatsAppOrder() {
  ...
  if (!validateForm() || cart.length === 0) {
    ...
    showWarningMessage("Por favor completa los datos y agrega productos al carrito");
    return;
  }
    if (!flexiblePhoneRegex.test(phoneInput)) {
    //alert("Por favor ingresa un número de teléfono válido.");
    showWarningMessage("Por favor ingresa un número de teléfono válido");
    return;
  }
  // guarda la orden antes de enviar el mensaje por wpp
  saveOrderToHistory()
  saveCustomerInfo()
